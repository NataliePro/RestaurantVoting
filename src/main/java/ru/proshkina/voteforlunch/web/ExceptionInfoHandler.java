...
import ru.proshkina.voteforlunch.util.ValidationUtil;
import ru.proshkina.voteforlunch.util.exception.*;

import javax.servlet.http.HttpServletRequest;
import java.util.Map;
import java.util.Optional;

import static ru.proshkina.voteforlunch.util.exception.ErrorType.*;

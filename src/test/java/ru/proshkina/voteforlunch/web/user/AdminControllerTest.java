...
import ru.proshkina.voteforlunch.service.user.UserTestData;
import ru.proshkina.voteforlunch.web.user.AdminController;
...
class AdminControllerTest extends AbstractControllerTest {
    ...
    void testDelete() throws Exception {
        ...
        UserTestData.assertMatch(userService.getAll(), ADMIN, USER2, USER3);
    }
